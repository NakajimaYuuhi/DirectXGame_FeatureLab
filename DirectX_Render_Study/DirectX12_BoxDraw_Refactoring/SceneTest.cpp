...
CSceneTest::CSceneTest()
{
    ...
    TextObject* textObj2 = (TextObject*)(ObjectManager::GetInstance().Instantiate(Scene::ID::NONE, ObjectTag::TEXT, "TextObject2"));
    ...
    TextObject* textObj3 = (TextObject*)(ObjectManager::GetInstance().Instantiate(Scene::ID::NONE, ObjectTag::TEXT, "TextObject3"));
